...
This guide provides comprehensive documentation for the **clean-code** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "clean-code - [your task description]"

# Example
claude "clean-code - analyze the current implementation"
```
...
def implement_clean_code(input_data):
    """
    Implement clean-code functionality.
