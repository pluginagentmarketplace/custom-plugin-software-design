...
This guide provides comprehensive documentation for the **design-patterns** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "design-patterns - [your task description]"

# Example
claude "design-patterns - analyze the current implementation"
```
...
def implement_design_patterns(input_data):
    """
    Implement design-patterns functionality.
