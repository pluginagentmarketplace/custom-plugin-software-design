...
This guide provides comprehensive documentation for the **solid-principles** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "solid-principles - [your task description]"

# Example
claude "solid-principles - analyze the current implementation"
```
...
def implement_solid_principles(input_data):
    """
    Implement solid-principles functionality.
