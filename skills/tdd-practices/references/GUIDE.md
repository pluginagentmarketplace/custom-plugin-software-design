...
This guide provides comprehensive documentation for the **tdd-practices** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "tdd-practices - [your task description]"

# Example
claude "tdd-practices - analyze the current implementation"
```
...
def implement_tdd_practices(input_data):
    """
    Implement tdd-practices functionality.
