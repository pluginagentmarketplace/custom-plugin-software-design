...
This guide provides comprehensive documentation for the **architecture-patterns** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "architecture-patterns - [your task description]"

# Example
claude "architecture-patterns - analyze the current implementation"
```
...
def implement_architecture_patterns(input_data):
    """
    Implement architecture-patterns functionality.
