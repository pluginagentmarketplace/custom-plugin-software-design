...
This guide provides comprehensive documentation for the **refactoring** skill in the custom-plugin-software-design plugin.
...
```bash
# Invoke the skill
claude "refactoring - [your task description]"

# Example
claude "refactoring - analyze the current implementation"
```
...
def implement_refactoring(input_data):
    """
